        ...
        {posts?.map((item) => {
          return (
            <Link
              href={`post/${item?.id}`}
              key={item?.id}
              className="bg-blue-400/20 border border-blue-600 rounded-lg p-3 space-y-2 hover:scale-105 transition-all duration-300 cursor-pointer"
            >
              <div className="">
              ...
              <p className="text-slate-200 font-semibold hover:underline hover:text-blue-700 bg-red-500 p-1 rounded-lg inline-block ">
                Read more
              </p>
            </Link>
          );
